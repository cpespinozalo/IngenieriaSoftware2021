...
public class Catalogo  implements Serializable {
    ...
    private static final String SQL_INSERT = "INSERT INTO MASCOTAS.TCATALOGO (CCATALOGO,NOMBRE,DESCRIPCION,ACTIVO) VALUES ((SELECT NVL(MAX(CCATALOGO),0)+1 FROM CONTABILIDAD.TCATALOGO),?,?,?) ";
