...
public class Sesion  implements Serializable {
    ...
    private static final String SQL_IDSESION = "SELECT NVL(MAX(IDSESION),0)+1 FROM MASCOTAS.TSESION ";
    private static final String SQL_SELECT = "SELECT IDSESION,USUARIO,TO_CHAR(FINICIOSESION,'DD-MM-YYYY HH24:MI:SS'),TO_CHAR(FFINSESION,'DD-MM-YYYY HH24:MI:SS'),RESULTADO,SISTEMA,CUSUARIO FROM MASCOTAS.TSESION WHERE IDSESION=? ";
    private static final String SQL_INSERT = "INSERT INTO MASCOTAS.TSESION (IDSESION,USUARIO,FINICIOSESION,RESULTADO,SISTEMA,CUSUARIO) VALUES (?,?,SYSTIMESTAMP,?,?,?) ";
    private static final String SQL_UPDATE = "UPDATE MASCOTAS.TSESION SET FFINSESION=SYSTIMESTAMP WHERE IDSESION=? ";
