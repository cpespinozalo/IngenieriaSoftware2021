...
public class Mascota implements Serializable{
    ...
    private static final String SQL_SELECT = "SELECT CEMPRESA,IDENTIFICACION,RAZONSOCIAL,DIRECCION,PAGINAWEB,TELEFONO,CPAIS,CPROVINCIA,CCIUDAD,REPRESENTANTE_LEGAL FROM MASCOTAS.TMASCOTA WHERE CMASCOTA=? ";
    private static final String SQL_INSERT = "INSERT INTO MASCOTAS.TMASCOTA (CEMPRESA,IDENTIFICACION,RAZONSOCIAL,DIRECCION,PAGINAWEB,TELEFONO,CPAIS,CPROVINCIA,CCIUDAD,REPRESENTANTE_LEGAL) VALUES ((SELECT NVL(MAX(CMASCOTA),0)+1 FROM CONTABILIDAD.TMASCOTA),?,?,?,?,?,?,?,?,?) ";
